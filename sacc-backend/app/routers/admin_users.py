...
async def list_users(admin: SuperAdmin, db: DbSession) -> UserListResponse:
...
@router.put("/{id}", response_model=MessageResponse, summary="修改用户")
...
@router.delete("/{id}", response_model=MessageResponse, summary="禁用/删除用户")
