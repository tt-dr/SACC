...
import { childrenToText, extractToc, formatDisplayDate, slugifyHeading } from "@/lib/markdown";
...
const markdownComponents: Components = {
  h2: ({ children }) => (
    <h2 id={slugifyHeading(childrenToText(children))} className="mb-3 mt-8 scroll-mt-[92px] text-[22px] font-bold leading-[1.3]">
      {children}
    </h2>
  ),
  h3: ({ children }) => (
    <h3 id={slugifyHeading(childrenToText(children))} className="mb-2.5 mt-6 scroll-mt-[92px] text-lg font-semibold">
      {children}
    </h3>
  ),
